...
const AI_RESPONSES = {
  'stem': { title: 'STEM Excellence Matches', scholarships: [
    { match: 95, title: 'NSF Graduate Research Fellowship', award: '$37,000/yr + $12,000 stipend', urgency: 'Deadline: Oct 15', tags: ['STEM', 'Research'] },
    { match: 88, title: 'SMART Scholarship', award: '$25,000–$38,000', urgency: 'Deadline: Dec 1', tags: ['Engineering', 'Full-Ride'] },
  ]},
  'ai': { title: 'AI & Research Matches', scholarships: [
    { match: 92, title: 'The Turing-Lovelace Fellowship', award: '$45,000 + Living Stipend', urgency: '6 days left!', tags: ['AI Ethics', 'Full-Ride'] },
    { match: 85, title: 'Next-Gen Innovators Grant', award: '$25,000 Research Budget', urgency: 'Deadline: Dec 15', tags: ['Research', 'Global'] },
  ]},
  ...
  'default': { title: 'Top Matches For You', scholarships: [
    { match: 94, title: 'Gates Millennium Scholarship', award: '$40,000/yr', urgency: 'Deadline: Jan 15', tags: ['Merit', 'Full-Ride'] },
    { match: 87, title: 'Coca-Cola Scholars Program', award: '$20,000', urgency: 'Deadline: Oct 31', tags: ['Leadership', 'National'] },
  ]},
};
...
export default function AiMatcherPage() {
  ...
  useEffect(() => {
    setUser(getUser());
    window.addEventListener('sq_update', () => setUser(getUser()));
  }, []);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      setLoading(false);
      addActivity({ icon: 'auto_awesome', iconColor: 'text-secondary', title: 'AI Search', sub: text.slice(0, 50), time: 'Just now' });
    }, 1200);
  };
